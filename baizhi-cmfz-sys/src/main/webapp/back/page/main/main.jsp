...
<head>
    <title>Title</title>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/back/easyui/css/themes/ui-pepper-grinder/easyui.css">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/back/easyui/js/echarts.js"></script>
    ...
    <script>
        ...
        $(function(){
            ...
            $tt = $("#tt");
            //初始化系统菜单
            $.post("${pageContext.request.contextPath}/menu/selectAll",function(menus){
